...
public class HOGDescriptor {
    ...
    public HOGDescriptor(Size size, Size size2, Size size3, Size size4, int i, int i2, double d, int i3, double d2, boolean z, int i4) {
        this.nativeObj = HOGDescriptor_1(size.width, size.height, size2.width, size2.height, size3.width, size3.height, size4.width, size4.height, i, i2, d, i3, d2, z, i4);
    }

    public HOGDescriptor(Size size, Size size2, Size size3, Size size4, int i, int i2, double d, int i3, double d2, boolean z) {
        this.nativeObj = HOGDescriptor_2(size.width, size.height, size2.width, size2.height, size3.width, size3.height, size4.width, size4.height, i, i2, d, i3, d2, z);
    }

    public HOGDescriptor(Size size, Size size2, Size size3, Size size4, int i, int i2, double d, int i3, double d2) {
        this.nativeObj = HOGDescriptor_3(size.width, size.height, size2.width, size2.height, size3.width, size3.height, size4.width, size4.height, i, i2, d, i3, d2);
    }

    public HOGDescriptor(Size size, Size size2, Size size3, Size size4, int i, int i2, double d, int i3) {
        this.nativeObj = HOGDescriptor_4(size.width, size.height, size2.width, size2.height, size3.width, size3.height, size4.width, size4.height, i, i2, d, i3);
    }

    public HOGDescriptor(Size size, Size size2, Size size3, Size size4, int i, int i2, double d) {
        this.nativeObj = HOGDescriptor_5(size.width, size.height, size2.width, size2.height, size3.width, size3.height, size4.width, size4.height, i, i2, d);
    }
