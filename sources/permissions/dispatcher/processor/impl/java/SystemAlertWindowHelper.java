...
public final class SystemAlertWindowHelper implements SensitivePermissionInterface {
    ...
    public void addHasSelfPermissionsCondition(MethodSpec.Builder builder, String activityVar, String permissionField) {
        ...
        builder.beginControlFlow("if ($T.hasSelfPermissions($N, $N) || $T.canDrawOverlays($N))", this.PERMISSION_UTILS, activityVar, permissionField, this.SETTINGS, activityVar);
    }
    ...
    public void addRequestPermissionsStatement(MethodSpec.Builder builder, String targetParam, String activityVar, String requestCodeField) {
        ...
        builder.addStatement("$T intent = new $T($T.ACTION_MANAGE_OVERLAY_PERMISSION, $T.parse(\"package:\" + $N.getPackageName()))", className, className, this.SETTINGS, this.URI, activityVar);
