...
public final class NetworkUtils {
    ...
    public static boolean getMobileDataEnabled() {
        ...
        try {
            telephonyManager = (TelephonyManager) Utils.getApp().getSystemService(BackupActivity.TAG_PHONE_MODEL);
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public static String getNetworkOperatorName() {
        TelephonyManager telephonyManager = (TelephonyManager) Utils.getApp().getSystemService(BackupActivity.TAG_PHONE_MODEL);
