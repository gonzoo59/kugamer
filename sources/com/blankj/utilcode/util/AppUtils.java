...
public final class AppUtils {
    ...
    public static Signature[] getAppSignatures(String str) {
        ...
        try {
            ...
            if (Build.VERSION.SDK_INT >= 28) {
                PackageInfo packageInfo = packageManager.getPackageInfo(str, Videoio.CAP_INTELPERC_IR_GENERATOR);
                if (packageInfo == null) {
                    return null;
                }
    ...
    public static Signature[] getAppSignatures(File file) {
        ...
        PackageManager packageManager = Utils.getApp().getPackageManager();
        if (Build.VERSION.SDK_INT >= 28) {
            PackageInfo packageArchiveInfo = packageManager.getPackageArchiveInfo(file.getAbsolutePath(), Videoio.CAP_INTELPERC_IR_GENERATOR);
