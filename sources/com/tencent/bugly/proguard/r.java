...
public final class r {
    ...
    private void a(final List<UserInfoBean> list, boolean z) {
        ...
        if (list != null && list.size() != 0 && (b2 = aa.b()) != null) {
            ...
            if (y != null && y.size() > 0) {
                for (Map.Entry<String, String> entry : y.entrySet()) {
                    Map<String, String> map12 = bvVar2.e;
        ...
        ai.a().a(1001, a4, ac.a().c().q, StrategyBean.a, ahVar, this.c == 1);
    }
    ...
    /* JADX WARN: Removed duplicated region for block: B:21:0x002b A[Catch: all -> 0x0092, TRY_ENTER, TryCatch #0 {, blocks: (B:3:0x0001, B:21:0x002b, B:23:0x003e, B:25:0x004c, B:28:0x0061, B:30:0x0067, B:32:0x006c, B:35:0x0073, B:38:0x0089, B:26:0x005b, B:6:0x0009, B:9:0x0010, B:12:0x0017, B:14:0x001d), top: B:44:0x0001 }] */
    ...
    */
    ...
    private boolean b(boolean z) {
        ...
        if (e) {
            ...
            long currentTimeMillis = System.currentTimeMillis();
            if (z) {
                am.a(file, String.valueOf(currentTimeMillis), (long) PlaybackStateCompat.ACTION_PLAY_FROM_MEDIA_ID, false);
                return true;
            }
            if (!file.exists()) {
                am.a(file, String.valueOf(currentTimeMillis), (long) PlaybackStateCompat.ACTION_PLAY_FROM_MEDIA_ID, false);
