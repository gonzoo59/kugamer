...
public final class ag {
    ...
    private static void e(List<b> list) {
        for (b bVar : list) {
            ...
            try {
                ...
                contentValues.put(FileDownloadModel.ID, bVar.a);
    ...
    public static List<b> a() {
        Cursor a2 = w.a().a("t_sla", new String[]{FileDownloadModel.ID, "_tm", "_dt"}, (String) null, "_tm", "30");
        if (a2 == null) {
            return null;
        }
        if (a2.getCount() <= 0) {
        ...
        while (a2.moveToNext()) {
            try {
                b bVar = new b();
                bVar.a = a2.getString(a2.getColumnIndex(FileDownloadModel.ID));
