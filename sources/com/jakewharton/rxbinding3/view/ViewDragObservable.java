...
public final class ViewDragObservable extends Observable<DragEvent> {
    ...
    public ViewDragObservable(View view, Function1<? super DragEvent, Boolean> handled) {
    ...
    private static final class Listener extends MainThreadDisposable implements View.OnDragListener {
        ...
        /* JADX WARN: Multi-variable type inference failed */
        public Listener(View view, Function1<? super DragEvent, Boolean> handled, Observer<? super DragEvent> observer) {
            Intrinsics.checkParameterIsNotNull(view, "view");
            Intrinsics.checkParameterIsNotNull(handled, "handled");
            Intrinsics.checkParameterIsNotNull(observer, "observer");
            this.view = view;
