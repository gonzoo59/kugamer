...
final class AdapterViewItemLongClickObservable extends Observable<Integer> {
    ...
    public AdapterViewItemLongClickObservable(AdapterView<?> view, Function0<Boolean> handled) {
    ...
    private static final class Listener extends MainThreadDisposable implements AdapterView.OnItemLongClickListener {
        ...
        public Listener(AdapterView<?> view, Observer<? super Integer> observer, Function0<Boolean> handled) {
            Intrinsics.checkParameterIsNotNull(view, "view");
            Intrinsics.checkParameterIsNotNull(observer, "observer");
            Intrinsics.checkParameterIsNotNull(handled, "handled");
            this.view = view;
