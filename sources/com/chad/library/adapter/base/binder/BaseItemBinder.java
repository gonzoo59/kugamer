...
public abstract class BaseItemBinder<T, VH extends BaseViewHolder> {
    ...
    public void convert(VH holder, T t, List<? extends Object> payloads) {
        Intrinsics.checkParameterIsNotNull(holder, "holder");
        Intrinsics.checkParameterIsNotNull(payloads, "payloads");
    }

    public void onChildClick(VH holder, View view, T t, int i) {
        Intrinsics.checkParameterIsNotNull(holder, "holder");
        Intrinsics.checkParameterIsNotNull(view, "view");
    }

    public boolean onChildLongClick(VH holder, View view, T t, int i) {
        Intrinsics.checkParameterIsNotNull(holder, "holder");
        Intrinsics.checkParameterIsNotNull(view, "view");
        return false;
    }

    public void onClick(VH holder, View view, T t, int i) {
        Intrinsics.checkParameterIsNotNull(holder, "holder");
        Intrinsics.checkParameterIsNotNull(view, "view");
    }
    ...
    public boolean onLongClick(VH holder, View view, T t, int i) {
        Intrinsics.checkParameterIsNotNull(holder, "holder");
        Intrinsics.checkParameterIsNotNull(view, "view");
        return false;
    }
