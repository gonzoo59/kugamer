...
public class XScopeAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    public XScopeAdapter(Context context, List<String> list, List<Boolean> list2) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        return new ViewHolder(this.mInflater.inflate(R.layout.xscope_row, viewGroup, false));
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            if (XScopeAdapter.this.mClickListener != null) {
                XScopeAdapter.this.mClickListener.onItemClick(view, getAbsoluteAdapterPosition());
            }
        }
    }
}
