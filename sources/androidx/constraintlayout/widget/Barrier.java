    ...
    protected void init(AttributeSet attributeSet) {
        ...
        if (attributeSet != null) {
            ...
            for (int i = 0; i < indexCount; i++) {
                ...
                if (index == android.support.constraint.R.styleable.ConstraintLayout_Layout_barrierDirection) {
                    setType(obtainStyledAttributes.getInt(index, 0));
                } else if (index == android.support.constraint.R.styleable.ConstraintLayout_Layout_barrierAllowsGoneWidgets) {
