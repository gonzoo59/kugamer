        ...
        while (z3) {
            ...
            if (z3) {
                ...
                while (true) {
                    ...
                    if (constraintWidget2.mListDimensionBehaviors[c] == ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT && constraintWidget2.getWidth() < constraintWidget2.getWrapWidth()) {
