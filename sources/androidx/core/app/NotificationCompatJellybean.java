...
public class NotificationCompatJellybean {
    ...
    private static boolean ensureActionReflectionReadyLocked() {
        ...
        try {
            if (sActionsField == null) {
                ...
                sActionIconField = sActionClass.getDeclaredField(Constants.FLOAT_TAG_BALL);
    ...
    public static NotificationCompat.Action getActionFromBundle(Bundle bundle) {
        ...
        return new NotificationCompat.Action(bundle.getInt(Constants.FLOAT_TAG_BALL), bundle.getCharSequence("title"), (PendingIntent) bundle.getParcelable("actionIntent"), bundle.getBundle("extras"), fromBundleArray(getBundleArrayFromBundle(bundle, "remoteInputs")), fromBundleArray(getBundleArrayFromBundle(bundle, "dataOnlyRemoteInputs")), bundle2 != null ? bundle2.getBoolean("android.support.allowGeneratedReplies", false) : false, bundle.getInt("semanticAction"), bundle.getBoolean("showsUserInterface"));
    }
    ...
    public static Bundle getBundleForAction(NotificationCompat.Action action) {
        ...
        bundle2.putInt(Constants.FLOAT_TAG_BALL, action.getIcon());
