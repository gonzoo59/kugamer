...
public final class ULongRange extends ULongProgression implements ClosedRange<ULong> {
    ...
    public /* bridge */ /* synthetic */ boolean contains(ULong uLong) {
        return m1053containsVKZWuLQ(uLong.m339unboximpl());
    }

    @Override // kotlin.ranges.ClosedRange
    public ULong getStart() {
        return ULong.m290boximpl(getFirst());
    }

    @Override // kotlin.ranges.ClosedRange
    public ULong getEndInclusive() {
        return ULong.m290boximpl(getLast());
    }

    /* renamed from: contains-VKZWuLQ  reason: not valid java name */
    public boolean m1053containsVKZWuLQ(long j) {
    ...
    public int hashCode() {
        ...
        return ((int) ULong.m296constructorimpl(getLast() ^ ULong.m296constructorimpl(getLast() >>> 32))) + (((int) ULong.m296constructorimpl(getFirst() ^ ULong.m296constructorimpl(getFirst() >>> 32))) * 31);
    }

    @Override // kotlin.ranges.ULongProgression
    public String toString() {
        return ULong.m333toStringimpl(getFirst()) + ".." + ULong.m333toStringimpl(getLast());
    }
