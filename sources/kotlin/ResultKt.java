...
public final class ResultKt {
    ...
    private static final <R> Object runCatching(Function0<? extends R> function0) {
        try {
            ...
            return Result.m142constructorimpl(function0.invoke());
        } catch (Throwable th) {
    ...
    private static final <T, R> Object runCatching(T t, Function1<? super T, ? extends R> function1) {
        try {
            Result.Companion companion = Result.Companion;
            return Result.m142constructorimpl(function1.invoke(t));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            return Result.m142constructorimpl(createFailure(th));
        }
    ...
    private static final <R, T extends R> R getOrElse(Object obj, Function1<? super Throwable, ? extends R> function1) {
        ...
        return m145exceptionOrNullimpl == null ? obj : function1.invoke(m145exceptionOrNullimpl);
    }
    ...
    private static final <R, T extends R> Object recover(Object obj, Function1<? super Throwable, ? extends R> function1) {
        ...
        Result.Companion companion = Result.Companion;
        return Result.m142constructorimpl(function1.invoke(m145exceptionOrNullimpl));
    }
    ...
    private static final <T> Object onFailure(Object obj, Function1<? super Throwable, Unit> function1) {
        Throwable m145exceptionOrNullimpl = Result.m145exceptionOrNullimpl(obj);
        if (m145exceptionOrNullimpl != null) {
            function1.invoke(m145exceptionOrNullimpl);
        }
        return obj;
    }
