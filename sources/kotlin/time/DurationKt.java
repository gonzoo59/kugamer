...
public final class DurationKt {
    ...
    private static final double m1154timesmvk6XK0(int i, double d) {
        return Duration.m1136timesimpl(d, i);
    }

    /* renamed from: times-kIfJnKk  reason: not valid java name */
    private static final double m1153timeskIfJnKk(double d, double d2) {
        return Duration.m1135timesimpl(d2, d);
    }

    public static final double toDuration(double d, TimeUnit unit) {
        Intrinsics.checkParameterIsNotNull(unit, "unit");
        return Duration.m1109constructorimpl(DurationUnitKt.convertDurationUnit(d, unit, TimeUnit.NANOSECONDS));
    }
}
