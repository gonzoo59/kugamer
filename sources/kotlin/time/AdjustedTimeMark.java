...
final class AdjustedTimeMark extends TimeMark {
    ...
    public double elapsedNow() {
        return Duration.m1132minusLRDsOJo(this.mark.elapsedNow(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    public TimeMark mo1106plusLRDsOJo(double d) {
        return new AdjustedTimeMark(this.mark, Duration.m1133plusLRDsOJo(this.adjustment, d), null);
    }
}
