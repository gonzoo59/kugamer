...
public final class UtilKt {
    ...
    public static final List<Annotation> computeAnnotations(Annotated computeAnnotations) {
        ...
        for (AnnotationDescriptor annotationDescriptor : computeAnnotations.getAnnotations()) {
        ...
        if (!(constantValue instanceof ArrayValue)) {
            if (constantValue instanceof EnumValue) {
                ...
                if (value2 instanceof KClassValue.Value.NormalClass) {
                    ...
                    ClassifierDescriptor mo1092getDeclarationDescriptor = ((KClassValue.Value.LocalClass) value2).getType().getConstructor().mo1092getDeclarationDescriptor();
