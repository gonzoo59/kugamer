...
public final class JavaDescriptorResolver {
    ...
    public final ClassDescriptor resolveClass(JavaClass javaClass) {
        ...
        if (outerClass != null) {
            ...
            ClassifierDescriptor contributedClassifier = unsubstitutedInnerClassesScope != null ? unsubstitutedInnerClassesScope.mo1094getContributedClassifier(javaClass.getName(), NoLookupLocation.FROM_JAVA_LOADER) : null;
            return contributedClassifier instanceof ClassDescriptor ? contributedClassifier : null;
        } else if (fqName == null) {
            return null;
        } else {
