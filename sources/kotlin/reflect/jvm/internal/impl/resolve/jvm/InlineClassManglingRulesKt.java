...
public final class InlineClassManglingRulesKt {
    ...
    public static final boolean isInlineClassThatRequiresMangling(KotlinType isInlineClassThatRequiresMangling) {
        Intrinsics.checkParameterIsNotNull(isInlineClassThatRequiresMangling, "$this$isInlineClassThatRequiresMangling");
        ClassifierDescriptor mo1092getDeclarationDescriptor = isInlineClassThatRequiresMangling.getConstructor().mo1092getDeclarationDescriptor();
        return mo1092getDeclarationDescriptor != null && isInlineClassThatRequiresMangling(mo1092getDeclarationDescriptor);
    }
