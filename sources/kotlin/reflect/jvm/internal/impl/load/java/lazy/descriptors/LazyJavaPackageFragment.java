...
public final class LazyJavaPackageFragment extends PackageFragmentDescriptorImpl {
    ...
    public LazyJavaPackageFragment(LazyJavaResolverContext outerContext, JavaPackage jPackage) {
        ...
        this.annotations = childForClassOrPackage$default.getComponents().getAnnotationTypeQualifierResolver().getDisabled() ? Annotations.Companion.getEMPTY() : LazyJavaAnnotationsKt.resolveAnnotations(childForClassOrPackage$default, jPackage);
