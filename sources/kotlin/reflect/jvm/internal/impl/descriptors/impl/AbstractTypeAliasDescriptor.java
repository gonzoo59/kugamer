...
public abstract class AbstractTypeAliasDescriptor extends DeclarationDescriptorNonRootImpl implements TypeAliasDescriptor {
    ...
    public AbstractTypeAliasDescriptor(DeclarationDescriptor containingDeclaration, Annotations annotations, Name name, SourceElement sourceElement, Visibility visibilityImpl) {
        ...
        this.typeConstructor = new TypeConstructor() { // from class: kotlin.reflect.jvm.internal.impl.descriptors.impl.AbstractTypeAliasDescriptor$typeConstructor$1
            ...
            public TypeAliasDescriptor mo1092getDeclarationDescriptor() {
            ...
            public Collection<KotlinType> mo1093getSupertypes() {
                Collection<KotlinType> mo1093getSupertypes = mo1092getDeclarationDescriptor().getUnderlyingType().getConstructor().mo1093getSupertypes();
                Intrinsics.checkExpressionValueIsNotNull(mo1093getSupertypes, "declarationDescriptor.un…pe.constructor.supertypes");
                return mo1093getSupertypes;
            }

            @Override // kotlin.reflect.jvm.internal.impl.types.TypeConstructor
            public KotlinBuiltIns getBuiltIns() {
                return DescriptorUtilsKt.getBuiltIns(mo1092getDeclarationDescriptor());
            }

            public String toString() {
                return "[typealias " + mo1092getDeclarationDescriptor().getName().asString() + ']';
            }
    ...
    public boolean isInner() {
        return TypeUtils.contains(getUnderlyingType(), new Function1<UnwrappedType, Boolean>() { // from class: kotlin.reflect.jvm.internal.impl.descriptors.impl.AbstractTypeAliasDescriptor$isInner$1
            ...
            public final boolean invoke2(UnwrappedType type) {
                ...
                return (mo1092getDeclarationDescriptor instanceof TypeParameterDescriptor) && (Intrinsics.areEqual(((TypeParameterDescriptor) mo1092getDeclarationDescriptor).getContainingDeclaration(), AbstractTypeAliasDescriptor.this) ^ true);
            }
        });
    }
