...
public final class AnnotationUtilKt {
    ...
    public static final AnnotationDescriptor createDeprecatedAnnotation(final KotlinBuiltIns createDeprecatedAnnotation, String message, String replaceWith, String level) {
        ...
        return new BuiltInAnnotationDescriptor(createDeprecatedAnnotation, fqName2, MapsKt.mapOf(TuplesKt.to(DEPRECATED_MESSAGE_NAME, new StringValue(message)), TuplesKt.to(DEPRECATED_REPLACE_WITH_NAME, new AnnotationValue(builtInAnnotationDescriptor)), TuplesKt.to(name, new EnumValue(classId, identifier))));
    }
