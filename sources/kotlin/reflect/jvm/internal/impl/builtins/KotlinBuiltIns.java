...
public abstract class KotlinBuiltIns {
    ...
    private static /* synthetic */ void $$$reportNull$$$0(int i) {
        ...
        switch (i) {
            ...
            case 137:
            case 139:
            case Constants.E_BLE_BUF_TYPE_AI_XSCOPE /* 147 */:
            case Constants.E_BLE_BUF_TYPE_GET_UUID /* 148 */:
            case Constants.E_BLE_BUF_TYPE_AI_SMART_QE /* 149 */:
                objArr[0] = "descriptor";
                break;
            case 11:
            case 94:
            ...
            case 142:
            case 143:
            case Constants.E_BLE_BUF_TYPE_GET_TOUPING_PARAM /* 144 */:
            case Constants.E_BLE_BUF_TYPE_SET_TOUPING_PARAM /* 145 */:
            case Constants.E_BLE_BUF_TYPE_AI_GUN_DOWN_OTHERS /* 146 */:
            case Constants.E_BLE_BUF_TYPE_SET_GAME_PARAM /* 151 */:
                objArr[0] = "type";
                break;
            case 45:
            ...
            case 70:
                ...
                break;
            case 72:
            case Constants.E_BLE_BUF_TYPE_CUSTOMIZE_PARAM /* 152 */:
            ...
            case 108:
                ...
                break;
            case Constants.E_BLE_BUF_TYPE_SET_M4_AI_STATE /* 150 */:
    ...
    public KotlinBuiltIns(StorageManager storageManager) {
        ...
        this.builtInClassesByName = storageManager.createMemoizedFunction(new Function1<Name, ClassDescriptor>() { // from class: kotlin.reflect.jvm.internal.impl.builtins.KotlinBuiltIns.3
            ...
            public ClassDescriptor invoke(Name name) {
                ClassifierDescriptor contributedClassifier = KotlinBuiltIns.this.getBuiltInsPackageScope().mo1094getContributedClassifier(name, NoLookupLocation.FROM_BUILTINS);
    ...
    public static boolean isPrimitiveArray(KotlinType kotlinType) {
        ...
        ClassifierDescriptor mo1092getDeclarationDescriptor = kotlinType.getConstructor().mo1092getDeclarationDescriptor();
        return (mo1092getDeclarationDescriptor == null || getPrimitiveArrayType(mo1092getDeclarationDescriptor) == null) ? false : true;
    }
    ...
    public static boolean isPrimitiveTypeOrNullablePrimitiveType(KotlinType kotlinType) {
        ...
        ClassifierDescriptor mo1092getDeclarationDescriptor = kotlinType.getConstructor().mo1092getDeclarationDescriptor();
        return (mo1092getDeclarationDescriptor instanceof ClassDescriptor) && isPrimitiveClass((ClassDescriptor) mo1092getDeclarationDescriptor);
    }
    ...
    public static boolean isTypeConstructorForGivenClass(TypeConstructor typeConstructor, FqNameUnsafe fqNameUnsafe) {
        ...
        return (mo1092getDeclarationDescriptor instanceof ClassDescriptor) && classFqNameEquals(mo1092getDeclarationDescriptor, fqNameUnsafe);
    }
    ...
    public static boolean isKClass(ClassDescriptor classDescriptor) {
        if (classDescriptor == null) {
            $$$reportNull$$$0(Constants.E_BLE_BUF_TYPE_AI_XSCOPE);
        }
    ...
    public static boolean isDeprecated(DeclarationDescriptor declarationDescriptor) {
        if (declarationDescriptor == null) {
            $$$reportNull$$$0(Constants.E_BLE_BUF_TYPE_SET_M4_AI_STATE);
        }
    ...
    public static FqName getPrimitiveFqName(PrimitiveType primitiveType) {
        if (primitiveType == null) {
            $$$reportNull$$$0(Constants.E_BLE_BUF_TYPE_CUSTOMIZE_PARAM);
        }
