...
public final class MediaType {
    ...
    public final String m1235deprecated_type() {
        return this.type;
    }
    ...
    public final String m1234deprecated_subtype() {
        return this.subtype;
    }
    ...
    public static final class Companion {
            ...
            if (group2 != null) {
                ...
                while (end < toMediaType.length()) {
                    ...
                    if (group3 == null || !StringsKt.equals(group3, "charset", true)) {
                        ...
                        if (!((str2 == null || StringsKt.equals(group4, str2, true)) ? true : true)) {
        ...
        public final MediaType m1236deprecated_get(String mediaType) {
        ...
        public final MediaType m1237deprecated_parse(String mediaType) {
            Intrinsics.checkParameterIsNotNull(mediaType, "mediaType");
