...
public final class PublicSuffixDatabase {
    ...
    public final String getEffectiveTldPlusOne(String domain) {
        ...
        if (split$default.size() != findMatchingRule.size() || findMatchingRule.get(0).charAt(0) == '!') {
            ...
            return SequencesKt.joinToString$default(SequencesKt.drop(CollectionsKt.asSequence(StringsKt.split$default((CharSequence) domain, new char[]{'.'}, false, 0, 6, (Object) null)), size - size2), ".", null, null, 0, null, null, 62, null);
        }
        return null;
    }
